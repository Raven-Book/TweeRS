 ...
 * @param {any} config_js
 * @returns {JsBuildOutput}
 */
export function build(config_js) {
    const ret = wasm.build(config_js);
    if (ret[2]) {
 ...
 * @param {any} sources_js
 * @returns {any}
 */
export function parse(sources_js) {
    const ret = wasm.parse(sources_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
 ...
 * @returns {JsBuildOutput}
 */
export function build_from_parsed(parsed_js) {
    const ret = wasm.build_from_parsed(parsed_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return JsBuildOutput.__wrap(ret[0]);
...
const JsBuildOutputFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_jsbuildoutput_free(ptr >>> 0, 1));
/**
...
export class JsBuildOutput {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(JsBuildOutput.prototype);
        obj.__wbg_ptr = ptr;
        JsBuildOutputFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        JsBuildOutputFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_jsbuildoutput_free(ptr, 0);
    }
    /**
     * @param {string} html
     */
    constructor(html) {
        ...
        const ret = wasm.jsbuildoutput_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        JsBuildOutputFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    get html() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.jsbuildoutput_html(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
